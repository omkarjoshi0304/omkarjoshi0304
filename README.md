...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=flat&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/omkarkjoshi/)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white)](https://github.com/omkarjoshi0304)
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat&logo=gmail&logoColor=white)](mailto:omkarkjoshi09@gmail.com)
...
**Core:** Python · Bash · Go · SQL
**AI/ML:** LLMs · RAG · FAISS · pgvector · Llama Stack · MCP · LangChain · PyTorch · Scikit-learn
**Cloud & Infra:** OpenShift · Kubernetes · Docker · Podman · AWS · Prometheus · Grafana
**Dev:** FastAPI · Django · Git · CI/CD · Linux · Jupyter
...
|---|---|---|
| [`lightspeed-core/lightspeed-stack`](https://github.com/lightspeed-core/lightspeed-stack) | Contributor | Core AI service — FastAPI, agent orchestration, RAG, MCP integration |
| [`openstack-lightspeed/rag-content`](https://github.com/openstack-lightspeed/rag-content) | Contributor | RHOSO documentation → vector embeddings pipeline |
| [`openstack-lightspeed/operator`](https://github.com/openstack-lightspeed/operator) | Contributor | Kubernetes operator automating Lightspeed deployment on OpenShift |
| [`lightspeed-core/lightspeed-providers`](https://github.com/lightspeed-core/lightspeed-providers) | Contributor | Custom LLM provider adapters for Llama Stack |
| [`lightspeed-core/rag-content`](https://github.com/lightspeed-core/rag-content) | Contributor | Shared RAG tooling — chunking, embedding, vector DB generation |
...
🎓 **BE, Electronics & Telecommunication Engineering** — University of Mumbai, India *(2020–2024)*
...
![Profile Views](https://komarev.com/ghpvc/?username=omkarjoshi0304&label=Profile%20Views&color=0e75b6&style=flat)
